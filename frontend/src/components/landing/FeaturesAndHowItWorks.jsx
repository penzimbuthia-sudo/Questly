    ...
    <section id="how-it-works" className="bg-page/50 py-14 sm:py-15 border-t border-line/10">
      <div className="w-full max-w-6xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div className="space-y-10">
          {/* Learners */}
          <div>
            <p className="text-xs mb-4 uppercase tracking-wide text-tone-info-fg font-bold">
              For learners
            </p>
          ...
          {/* Contributors */}
          <div>
            <p className="text-xs mb-4 uppercase tracking-wide text-tone-warning-fg font-bold">
              For contributors
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-4xl">
