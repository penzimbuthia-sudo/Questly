import { Search, Filter, Plus, Edit, Trash2, Eye, Award, Users, Star, Zap, Target, Flame, Crown, CheckCircle, FileText, MapPin, ThumbsUp, Heart } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
          ...
          <p className="text-2xl font-bold text-blue-600">5,830</p>
          <p className="text-xs text-slate-500">Spark ignited</p>
        </div>
        <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
          <p className="text-sm text-slate-500">Least Unlocked</p>
          <p className="text-2xl font-bold text-purple-600">196</p>
          <p className="text-xs text-slate-500">Path pioneer</p>
        </div>
        <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
          <p className="text-sm text-slate-500">Total Unlocked</p>
          <p className="text-2xl font-bold text-green-600">16,683</p>
        </div>
      </div>
    </div>
  );
