...
import { Search, Filter, Plus, Edit, Trash2, Eye, Video, FileText, BookOpen, Eye as ViewIcon, X } from 'lucide-react';
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
          ...
          <p className="text-2xl font-bold text-blue-600">
            {resources.reduce((sum, r) => {
              const views = r.views === '—' ? 0 : parseInt(r.views.replace('k', '000'));
              return sum + views;
            }, 0).toLocaleString()}
          </p>
        </div>
          ...
          <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md p-6 mx-4">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                ...
                <Button variant="primary" className="flex-1" onClick={handleAddResource}>
                  Add Resource
                </Button>
              </div>
            </div>
